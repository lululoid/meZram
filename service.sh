...
set --
set "ro.lmk.low" "ro.lmk.upgrade_pressure" "ro.lmk.kill_heaviest_task" "ro.lmk.kill_timeout_ms" "ro.lmk.psi_complete_stall_ms" "sys.lmk.minfree_levels" "ro.lmk.downgrade_pressure" "ro.lmk.medium" "ro.lmk.critical" "ro.lmk.critical_upgrade" "ro.lmk.swap_util_max" "ro.lmk.thrashing_limit_decay"
