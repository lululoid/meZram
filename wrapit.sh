...
sed -i "s#\"zipUrl\": \"https://github.com/lululoid/meZram/releases/download/v[0-9.]*_[0-9]*/meZram-v[0-9.]*_[0-9]*.zip\",#\"zipUrl\": \"https://github.com/lululoid/meZram/releases/download/v$version\_$versionCode/meZram-v$version\_$versionCode.zip\",#g; s#\"changelog\": \"https://github.com/lululoid/meZram/releases/download/v[0-9.]*_[0-9]*/meZram-v[0-9.]*_[0-9]*-changelog.md\"#\"changelog\": \"https://github.com/lululoid/meZram/releases/download/v$version\_$versionCode/meZram-v$version\_$versionCode-changelog.md\"#g" meZram.json
